...
import { GenerateFileTestsInput, TestFileSchema } from "./schema";
...
Respond with an array of test files with their name being the path to the test file and the content being the full contents of the test file. Follow these conventions:
